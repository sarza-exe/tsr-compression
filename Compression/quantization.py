...
from metrics_utils import count_params, count_flops, measure_latency, get_file_size_mb
...
def apply_static_quantization(model, data_loader):
    ...
    # Wrap the model to handle Float input
